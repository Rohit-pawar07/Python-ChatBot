...
c1 = '#8E35EF'#dark blue
c2 = '#faa21f'#oranigish yellow
c3 = '#1e282d'#blueish black
c6 = '#FFD801'#yellow

c4 = '#faa21f'
c5 = '#577e75'#lightblueish

c7 = '#1e282d'#black
c8 = '#faa21f'
c9 = '#7D0552'#purple
c10 = '#C11B17'#red chili
c11 = '#0C090A'#black night
c12 = "#008080"#teal
c13 = "#F0FFFF"#white
...
a seperate window for writing answer
    ...
    label = Label (frame_root , text = 'Enter the Question here ...' , bg = c1 , fg = 'white' )
    label.pack()
...
function for producing response of
    ...
    label_request = Label(frame_chats ,text=chat_raw , bg = c10 , fg= c13  , justify = LEFT , wraplength = 300, font = 'Verdana 10 bold')
...
def get_response() :
    ...
    label_response = Label(frame_chats ,text= answer ,bg=c12  , fg = c13 , justify = LEFT , wraplength = 300, font = 'Verdana 10 italic')
...
frame_welcome = Frame (root , bg = c1 , height = '690' , width = '550')
...
welcome_chatbot = Label (frame_welcome , text = 'I Am Chatbot ! ' , font = "Helvetica 22 bold" , bg = c1 , fg = c6)
welcome_chatbot.place(x = 180 , y = 250)

pic_1 = Label (frame_welcome , image = screen_1)
pic_1.place(x = 30 , y = 305 )

button_front = Button (frame_welcome , image = front , relief = "flat" , bg = c1 , bd = "2px solid black" , command = welcome_to_info ).place(x=470 , y=20)
...
button_time = Button (frame_welcome , text = 'Time' , height = 1 , font = 'Vardana 10 bold' ,  width = 8 , bg = c2 , fg = c10 ,  command = clock)
...
button_date = Button (frame_welcome , text = 'Date' ,height = 1 , font = 'Vardana 10 bold' ,  width = 8 , bg = c2 , fg= c10 , command = date)
...
label_sub = Label (frame_info ,text = "Enter Information" , bg = c1 , fg = "black" , font = 'Verdana 30 bold')
label_sub.pack()
                            
user_name = Label (frame_info , text = 'Enter your name : ' , bg = c1 , fg = c11 , font = 'Ariel 15')
user_name.place(x = 80,y=130)

entry_user = Text (frame_info , bg = c6, fg = c11 , height ='1'  , width ='40' , font = 'Ariel 15')
entry_user.focus()
entry_user.place(x = 80 , y = 170)

chatbot_name = Label (frame_info , text = 'Give Chatbot a Name : ' , bg = c1 , fg = c11 , font = 'Ariel 15')
chatbot_name.place(x = 80 , y = 220)

entry_chat = Text (frame_info , bg = c6, fg = c11 , height ='1'  , width ='40' , font = 'Ariel 15')
entry_chat.place(x = 80 , y = 260)

button_1 = Button (frame_info , text ='submit' , font = 'Vardana 10 bold' , bg = c10 , fg = c11 , command = info )
button_1.place(x = 460 , y = 360)

button_back = Button (frame_info , image =  back , relief = "flat" , bg = c1 , command = info_to_welcome).place(x=20 , y = 30)
...
frame_chat = Frame (root , bg = c1 , height = '685' , width = '560')
frame_chat.pack_propagate(0)

frame_top = Frame( frame_chat , bg = c3 , height = '100' , width = '550')
frame_top.pack()

label_topic = Label ( frame_top , bg = c3 , fg = 'white' , font = 'Verdana 15 bold ')
...
button_refresh = Button (frame_chat , bg = c10 , fg = c2 ,  text = 'refresh' , font = 'Vardana 10 bold' ,  command =refresh_screen)
button_refresh.place(x = 480 , y = 70)
...
button_front = Button (frame_chat , image = exitt , relief = "flat" , bg = c3 , command = root.destroy ).place(x=445 , y = 10)
